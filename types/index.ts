...
/**
 * Avaliação pública da vitrine.
 * Shape fiel ao retorno de GET /api/public/business/:slug/reviews
 * (review.service.ts → listPublicReviews: scalars do ScheduleReview +
 * include customer { name, picture } + schedule.scheduleServices c/ service.name).
 */
...
/** Estatísticas agregadas das avaliações públicas da loja */
export interface ReviewStats {
  totalReviews: number
  /** Média 1–5 com 1 casa decimal; null quando não há reviews */
