 ...
 *
 * Painel reutilizável: usado na tab Pós-venda (/dashboard/pos-venda) e nas rotas
 * legadas /dashboard/relatorios/recalls (mantidas por compatibilidade de links).
  ...
  return (
    <div>
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
        ...
        <h2 style={{ fontSize: 20, fontWeight: 800, color: "var(--c-text)", margin: 0, letterSpacing: "-0.5px" }}>Retornos & Garantias</h2>
      </div>
