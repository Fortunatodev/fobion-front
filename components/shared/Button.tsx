  ...
  "inline-flex items-center justify-center gap-2 rounded-xl font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 disabled:opacity-50 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-[var(--c-border)] hover:bg-[var(--c-border-2)] text-[var(--c-text)] border border-[var(--c-border-2)] hover:border-[#3F3F3F]",
        ghost:
          "hover:bg-[var(--c-border)] text-[var(--c-text-2)] hover:text-[var(--c-text)]",
        danger:
          "bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/30",
        outline:
          "border border-[var(--c-border-2)] hover:border-primary/50 text-[var(--c-text)] hover:bg-primary/5",
      },
      size: {
        sm: "h-8 px-3 text-sm",
